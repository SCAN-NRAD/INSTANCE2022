...
def train_equivariant(epoch_end,cutoff='right',downsample=3,gpu='cuda',equivariance='SO3',n=3):
    ...
    dataset = INSTANCE_2022(training_cases, patch_size = 128) 
...
def predict_equivariant(gpu='cuda', downsample = 3, cutoff='right',equivariance='SO3',n=3):
